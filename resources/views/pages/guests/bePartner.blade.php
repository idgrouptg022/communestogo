...
@section('content')
    <section class="section-container">
        <div class="page-header-container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Devenir partenaire sur un projet communal</li>
            </ol>
    ...
    <h2 class="page-title">Devenir partenaire sur un projet communal</h2>
    <section class="section-container">
                        ...
                        @foreach ($communes::all($prefecture->id) as $commune)
                            <a
                                @if($communeLink::getCommuneLink($commune->id) != null)
                                    href="{{ $communeLink::getCommuneLink($commune->id)->be_partner ?? '#!' }}"
                                @endif
                                class="communes-item">
