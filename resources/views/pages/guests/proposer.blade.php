...
@section('content')
    <section class="section-container">
        <div class="page-header-container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Proposer un projet dans ma commune</li>
            </ol>
    ...
    <h2 class="page-title">Proposer un projet dans ma commune</h2>
    <section class="section-container">
                        ...
                        @foreach ($communes::all($prefecture->id) as $commune)
                            <a
                                @if($communeLink::getCommuneLink($commune->id) != null)
                                    href="{{ $communeLink::getCommuneLink($commune->id)->give_project ?? '#!' }}"
                                @endif
                                class="communes-item">
