...
@section('content')
    <section class="section-container">
        <div class="page-header-container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Présentation de commune</li>
            </ol>
    ...
    <h2 class="page-title">Présentation de commune</h2>
    <section class="section-container">
                        ...
                        @foreach ($communes::all($prefecture->id) as $commune)
                            <a
                                @if($communeLink::getCommuneLink($commune->id) != null)
                                    href="{{ $communeLink::getCommuneLink($commune->id)->culture ?? '#!' }}"
                                @endif
                                class="communes-item">
