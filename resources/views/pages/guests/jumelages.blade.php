...
@section('content')
    <section class="section-container">
        <div class="page-header-container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Jumelages dans ma commune</li>
            </ol>
    ...
    <h2 class="page-title">Jumelages dans ma commune</h2>
    <section class="section-container">
                        ...
                        @foreach ($communes::all($prefecture->id) as $commune)
                            <a
                                @if($communeLink::getCommuneLink($commune->id) != null)
                                    href="{{ $communeLink::getCommuneLink($commune->id)->jumelage ?? '#!' }}"
                                @endif
                                class="communes-item">
